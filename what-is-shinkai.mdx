...
description: 'Shinkai is a free, open-source AI app designed to run directly on your computer'
icon: 'circle-question'
---

Build powerful AI agents in minutes—no coding experience needed. Native crypto support included.

Define their tasks, schedule actions, and even have Shinkai's AI write custom code for you.

Check out the video below to see how easy it is to create and test an agent in action.
...
<video
  ...
  src="https://pub-5b510bf382c744c093bdd1619d2d6d3e.r2.dev/add-ai.mp4"
/>
...
<video
  ...
  playsInline="true"
  className="w-full aspect-video"
  src="https://pub-0f9ce9e619a7477aa6e92197a3ec4a1e.r2.dev/assets/shinkai-docs-chat-ai.mp4"
/>
