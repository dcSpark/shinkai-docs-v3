...
Build crypto AI agents in minutes—no code required.
...
(Video of setting up an agent: maybe doing the Solana arbitrage?)
...
(the list should be: agent creation, code generation for agents, chat + tool execution, MCP creation, Flexible AI Models, Decentralized Network and AI Agent Store)

1. [Agent Creation](#agent-creation)
2. [Code Generation (Stand-alone Tools or Agents)](#code-generation)
3. [Chat + Tool Execution](#chat-tool-execution)
4. [MCP Creation](#mcp-creation)
5. [Flexible AI Models](#flexible-ai-models)
6. [Decentralized Network](#decentralized-network)
7. [AI Agent Store](#ai-agent-store)
...
### Code Generation (Stand-alone Tools or Agents) {#code-generation}
...
### Chat + Tool Execution {#chat-tool-execution}
...
### Flexible AI Models {#flexible-ai-models}
...
Join Shinkai's decentralized network to unlock powerful collaborative features:

- **Peer-to-Peer Capabilities**:
  - Skill sharing between nodes
  - Distributed computation
  - Resource pooling
- **Economic Layer**:
  - Automated micropayments for services
  - Token-based incentives
  - Fair compensation for resource sharing
- **Network Benefits**:
...
Discover and share AI agents in our comprehensive marketplace:
...
<video
  ...
  playsInline
  className="w-full aspect-video"
  src="/videos/architecture-overview.mp4"
></video>

<Card>
  <Icon icon="check" size={24}/> Shinkai runs AI models locally on your device or in the cloud, giving you the flexibility of private, low-latency processing or scalable compute on demand.
</Card>

<Card>
  <Icon icon="check" size={24}/> Define and generate powerful TypeScript and Python tools with Shinkai's AI-driven code engine in seconds.
</Card>

<Card>
  <Icon icon="check" size={24}/> Connect to the decentralized Shinkai Network for peer‑to‑peer skill sharing and seamless micro‑payments.
</Card>
...
<Card
  ...
  icon="file"
  href="https://download.shinkai.com/Shinkai_Protocol_Whitepaper_v2.pdf"
>
...
By registering, your device (or node) becomes part of the decentralized Shinkai Network. Your AI will automatically discover and pull in fresh, AI-ready content and shared tools from other nodes—keeping your agents updated with the latest skills and data.
