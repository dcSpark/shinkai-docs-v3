...
You can see the capabilities of this Cardano AI Agent in the video below.

<video
  controls
  playsInline
  className="w-full aspect-video"
  src="https://drive.google.com/file/d/1wR1a7Nv458KdeP93tVpGrotJlt72TdKY/view?usp=drive_link"
></video>
...
These prompts are from the preview screenshots of our Taptools Cardano tools available in the Shinkai AI Store. You can see most of our Cardano AI Agent answers on these screenshots on their respective pages. Some prompts and answers can also be viewed in the demo video at the top of this page.
...
And you can find an example of Telegram bot deployment in the video at the top of this page, as well as in this [NASA Agent demo](https://youtu.be/Yct9NNzXlXM?feature=shared&t=709).
