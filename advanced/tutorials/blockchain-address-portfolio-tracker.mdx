...
Shinkai allows effortless buidling of tools and AI Agents thanks to its integrated in AI assistance. You can build the tool by just prompting a LLM. With Shinkai, you don’t have to wrestle with library dependencies or handle manual deployments, everything is automated and user-friendly.

In this [video](https://drive.google.com/file/d/1wR1a7Nv458KdeP93tVpGrotJlt72TdKY/view?t=16m02s) we build in just a few minutes a working prototype of the Cardadano portfolio tracker tool data retrieval feature, by just giving some instructions and passing some documentation snippets about the API used.
