...
In this tutorial, we will build a cryptocurrency address portfolio tracker tool.
...
While we use a Cardano example, the same tool structure can be applied to any blockchain for which an API provide such data.
