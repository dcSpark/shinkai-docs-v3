...
![Agent Overview](/images/agent_tab.png)
...
### 6.3 Example: “knwowledge_repair_mate.pdf”
- If your Agent’s knowledge includes a PDF with knowledge of best DIY repair practices and tutorial resources, the LLM can pull top resources when searching guides, and include best recomendations in its answers.

![Add Context Documents](/images/agent_knowledge.png)
...
![Agent Selector 1](/images/selecting_agent_1.png)

![Agent Selector 2](/images/selecting_agent_2.png)
