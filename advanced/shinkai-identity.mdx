...
<Steps titleSize="h3" >
  <Step title="Acquire Base Sepolia (free)">
    Use the following faucet link to acquire Base Sepolia `Eth` (for gas fees), and Shinkai `KAI` tokens (for registering your identity) at no charge: https://faucet.shinkai.com/.
