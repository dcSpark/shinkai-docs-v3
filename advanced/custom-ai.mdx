---
title: 'AI Models'
description: 'Understanding AI model parameters and capabilities'
icon: 'robot'
---

<Info>
Shinkai supports both local AI models (powered by Ollama) and cloud AI models from major providers.
See [Local Models](/advanced/models/local-models) or [Cloud Models](/advanced/models/cloud-models) for installation guides.
</Info>
